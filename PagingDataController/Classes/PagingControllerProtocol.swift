...
public protocol PagingControllerProtocol: AnyObject {
	...
	func loadDataPage(_ page: Int, start: (() -> ())?, done: (() -> ())?)
	func nextPage() -> Int
...
public extension PagingControllerProtocol {
	...
	public var dataSource: PageDataSource<PagingProvider.Model> {
		get {
			return associatedObject(self, key: &sourceKey)
			{
		...
		set { associateObject(self, key: &sourceKey, value: newValue) }
	}
    
    //////////////////////////////////////////////////////////////////////////////////////
    
    public func loadDataPage(_ page: Int, start: (() -> ())? = nil, done: (() -> ())? = nil) {
        start?()
	...
	public func loadFirstPageWithCompletion(_ done: (() -> ())? = nil) {
		loadDataPage(0, start: nil, done: done)
	}
	public func loadNextPageWithCompletion(_ done: (() -> ())? = nil) {
